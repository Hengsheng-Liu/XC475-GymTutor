...
const ChatPage: React.FC<Props> = ({ navigation }) => {
  ...
  // Define the user function here
  const getUser = () => {
    return {
      name: (User?.displayName) || "no name", // Assuming the name is passed through navigation params
      _id: Fire.shared.uid, // UID from your Fire class
    };
  };
